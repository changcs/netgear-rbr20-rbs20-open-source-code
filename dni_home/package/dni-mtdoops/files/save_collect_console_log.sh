...
wl5g_NORMAL_AP=$(/bin/config get wla_2nd_NORMAL_AP)
wl2g_NORMAL_AP=$(/bin/config get wlg_NORMAL_AP)
wl5g_BACKHAUL_AP=$(/bin/config get wla_BACKHAUL_AP)
wl2g_BACKHAUL_AP=$(/bin/config get wlg_BACKHAUL_AP)
wl5g_BACKHAUL_STA=$(/bin/config get wla_BACKHAUL_STA)
wl2g_BACKHAUL_STA=$(/bin/config get wlg_BACKHAUL_STA)
